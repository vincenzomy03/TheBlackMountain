    ...
    public final void initDatabase() {
        try {
            ...
            stm.execute("CREATE TABLE IF NOT EXISTS CHARACTERS("
                    ...
                    + "ROOM_ID INT DEFAULT 0);"); // ← CORREZIONE: Default a 0 invece di 1
            stm.close();
    ...
    private void insertRoomsIfEmpty(Connection conn) throws SQLException {
        ...
        if (count == 0) {
            ...
            stm.execute("INSERT INTO ROOMS VALUES "
                    ...
                    + "(2, 'Mensa Abbandonata', 'Le tavole di legno sono rovesciate, piatti infranti ovunque.', "
                    + "'Non sembra esserci nulla di valore qui, a parte due goblin chiassosi pronti a combattere.', TRUE, 'mess_hall'), "
                    ...
                    + "(4, 'Sala delle Guardie', 'I resti di un banchetto interrotto sono sparsi ovunque.', "
    ...
    private void insertObjectsIfEmpty(Connection conn) throws SQLException {
        ...
        if (count == 0) {
            ...
            stm.execute("INSERT INTO OBJECTS VALUES "
                    ...
                    + "(4, 'stringhe di ragnatela', 'Filamenti spessi e resistenti. Potrebbero servire per creare qualcosa di utile.', 'ragnatela,filo,stringhe,stringa,ragnatele', FALSE, TRUE, FALSE, FALSE, FALSE, 'NORMAL'), "
