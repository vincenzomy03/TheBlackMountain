...
public class CombatSystem {
    ...
    public CombatSystem(GameDescription gameDescription) {
        ...
        this.player = new Character(0, "Giocatore", "Il coraggioso avventuriero", 100, 15, 5, CharacterType.PLAYER);
    }
    ...
    public String startCombat() {
        ...
        switch (roomId) {
            case 0: // Ingresso - Goblin
                enemies.add(new Character(1, "Goblin", 
    ...
    private String processPlayerAction(ParserOutput parserOutput) {
        ...
        if (commandName.equals("usa") || parserOutput.getCommand().getName().equals("usa")) {
            ...
            if (parserOutput.getInvObject() != null) {
                Objects obj = parserOutput.getInvObject();
            ...
            if (commandName.contains("cura") || commandName.equals("usa cura")) {
                ...
                Objects healPotion = GameUtils.getObjectFromInventory(gameDescription.getInventory(), 2);
                if (healPotion == null) {
            ...
            if (commandName.contains("spada") || commandName.equals("usa spada")) {
                Objects sword = GameUtils.getObjectFromInventory(gameDescription.getInventory(), 12);
                if (sword != null) {
            ...
            if (commandName.contains("arco") || commandName.equals("usa arco")) {
                Objects bow = GameUtils.getObjectFromInventory(gameDescription.getInventory(), 7);
                if (bow != null) {
    ...
    private String attackEnemy(Weapon weapon) {
        ...
        Character target = enemies.get(0);
     ...
     */
    private String useHealingPotion(Objects potion) {
        int healAmount;
     ...
     * @return risultato dell'azione
     */
    private String processEnemyAction(Character enemy) {
